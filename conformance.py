...
CONFORMANCE_TEST_CASE = [
    ("operations/list",'{}', dab.operations.list, 500, "Conformance"),
    ...
    ("system/settings/set",'{"outputResolution": {"width": 3840, "height": 2160, "frequency": 60} }', dab.system.set, 4000, "outputResolution"),
    ...
    ("input/key-press",'{"keyCode": "KEY_DOWN"}', dab.input.key_press, 1000, "KEY_DOWN", "Launch YT and go to home page"),
    ...
    ("input/key-press",'{"keyCode": "KEY_PLAY_PAUSE"}', dab.input.key_press, 1000, "KEY_PLAY_PAUSE"),
    ("input/key-press",'{"keyCode": "KEY_VOLUME_UP"}', dab.input.key_press, 1000, "KEY_VOLUME_UP", "Launch YT and play content with sound"),
    ...
    ("input/long-key-press",'{"keyCode": "KEY_VOLUME_UP", "durationMs": 3000}', dab.input.long_key_press, 5000, "KEY_VOLUME_UP", "Launch YT and play content"),
    ...
    ("input/long-key-press",'{"keyCode": "KEY_DOWN", "durationMs": 3000}', dab.input.long_key_press, 5000, "KEY_DOWN", "Launch YT and go to home page"),
    ...
    ("input/long-key-press",'{"keyCode": "KEY_PLAY_PAUSE", "durationMs": 3000}', dab.input.long_key_press, 5000, "KEY_PLAY_PAUSE", "Launch YT and play content"),
